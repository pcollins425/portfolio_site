...
from app.routers import assistant, assets, auth, commerce, contracts, documents, emaint_demo, expenses, field, master_revenue, media, parts_inventory, projects, slot_master, software_vault, warehouse_inventory
