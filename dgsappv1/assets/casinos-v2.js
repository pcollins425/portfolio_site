(function () {
  ...
  const els = {
    ...
    dealFields: document.getElementById("deal-fields"),
  };
  ...
  function dealCard(casinoId, deal) {
  ...
  function renderDetailFields(d) {
    ...
    renderHubspotContacts(d);
    renderHubspotDeals(d);
  }
